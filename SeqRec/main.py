...
import data
import model
from SeqRec.util import get_all_dataset

parser = argparse.ArgumentParser(description='PyTorch Wikitext-2 RNN/LSTM Language Model')
parser.add_argument('--bert_model', type=str, default="../../data/Movies_and_TV_5")
...
fname = "data_Movies_and_TV_5_10_core"
dataset = get_all_dataset(fname)
