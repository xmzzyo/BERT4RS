...
from pytorch_pretrained_bert.modeling import BertForPreTraining, BertConfig, BertModel
...
class BERTDataset(Dataset):
    ...
    def get_random_line(self):
        """
        Get random line from another document for nextSentence tasks.
...
def random_word(tokens, tokenizer):
    """
    Masking some random tokens for Language Model tasks with probabilities as in the original BERT paper.
...
def main():
    ...
    parser.add_argument("--train_file",
                        default='data/Movies_and_TV_5/data_Movies_and_TV_5.txt',
                        type=str,
                        help="The input train corpus.")
    parser.add_argument("--bert_model",
                        default='data/Movies_and_TV_5',
                        type=str,
                        help="Bert pre-trained model selected in the list: bert-base-uncased, "
                             "bert-large-uncased, bert-base-cased, bert-base-multilingual, bert-base-chinese.")
    parser.add_argument("--output_dir",
                        default='data/Movies_and_TV_5/checkpoint_v1',
                        type=str,
    ...
    config = BertConfig(
        vocab_size_or_config_json_file=50057,
        hidden_size=256,
        num_hidden_layers=8,
        ...
        for eph in trange(int(args.num_train_epochs), desc="Epoch"):
            ...
            for step, batch in enumerate(tqdm(train_dataloader, desc="Iteration")):
                ...
                if args.fp16:
                    ...
                    loss.backward()
                tr_loss += loss.item()
                logger.info('loss：'+str(tr_loss/(nb_tr_steps+1)))
